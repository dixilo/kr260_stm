...
### enc_1 diff
create_bd_port -dir I enc_1_p
create_bd_port -dir I enc_1_n
create_bd_cell -type ip -vlnv [latest_ip util_ds_buf] util_ds_buf_1
connect_bd_net [get_bd_ports enc_1_p] [get_bd_pins util_ds_buf_1/IBUF_DS_P]
connect_bd_net [get_bd_ports enc_1_n] [get_bd_pins util_ds_buf_1/IBUF_DS_N]
...
connect_bd_net [get_bd_pins util_ds_buf_1/IBUF_OUT] [get_bd_pins xlconcat_enc/In1]
...
set_property CONFIG.C_FIFO_DEPTH {256} [get_bd_cells axi_quad_spi]
